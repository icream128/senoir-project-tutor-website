                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    @else
                        <div class="dropdown" style="margin-left:15px;">
                            ...
                            id="menu1" data-toggle="dropdown"  style="border-radius:50%;object-position:center;object-fit: cover; margin-left:10px" alt="Cinque Terre" width="40px" height="40px">
                            <a class="nav-link js-scroll-trigger" style="color:#f05f40;" id="menu1" data-toggle="dropdown">{{$learnerProfile->username}}</a>
                            <img border="0" src="/img/sort-down.png" class="img-circle img-responsive"
                            id="menu1" data-toggle="dropdown"  style="object-position:center;margin-left:3px;margin-top:10px" alt="Cinque Terre" width="20px" height="20px">

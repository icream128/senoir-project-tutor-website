...
@section('content')
    <br>
    <div id="services" class="col-md-12 text-center" style="margin-top:90px">
                                    ...
                                    <div class="row">
                                        <center>
                                            ...
                                            <div style="margin-top:20px;">
                                                <img src="" id="blah1" alt="" width="300px" height="300px" class="img-circle" value="{{$learnerProfile->img_profile}}" style="object-fit: none; object-position: center; object-fit: cover;">

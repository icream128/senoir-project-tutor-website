    ...
    <nav id="tf-menu" class="navbar navbar-default navbar-fixed-top">
        <div class="container">
            ...
            <div class="navbar-header">
              ...
              <a class="navbar-brand" href="{{ url('/tutor') }}">HaTewDealNgan</a>
            </div>

            <!-- Collect the nav links, forms, and other content for toggling -->
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
              <ul class="nav navbar-nav navbar-right">
                <li><a href="{{ url('/tutorhistory') }}" class="scroll">ประวัติติวเตอร์</a></li>
                <li><a href="{{ url('/tutorshowdetail') }}" class="scroll">รายละเอียดคอร์ส</a></li>
                <li><a href="{{ url('/') }}" class="scroll">เข้าสู่ระบบ</a></li>

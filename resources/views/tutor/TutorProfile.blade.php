...
@section('content')
    ...
    <div class="text-right" style="margin: 10px">
        <a class="btn btn-xl js-scroll-trigger" style="font-size: 20px;background-color: #FF8000;color: #ffffff;" href="/tutoreditprofile&<?php echo $tutorProfilePage->user_id ?>">แก้ไขโปรไฟล์</a>
    </div>

...
<html lang="en">
  ...
  <body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li><a href="{{ url('/') }}" class="scroll">สมัครสมาชิก</a></li>
              </ul>
            </div><!-- /.navbar-collapse -->
        </div><!-- /.container-fluid -->
    </nav>
    ...
    <div class="form-group">
        <div class="col-sm-2">
            <ul id="nava" class="nav nav-pills nav-stacked">
                <li><a href="tutorteaching" class="scroll">คอร์สที่กำลังสอน</a></li>
                <li><a href="tutorhistory" class="scroll">คอร์สที่สอนเสร็จแล้ว</a></li>
                <li><a href="" class="scroll">คอร์สที่ถูกยกเลิก</a></li>
            </ul>
        </div>    
        <div id="content" class="col-sm-9" style="background-color:#ffffff;"></div>
    </div>
    </center>

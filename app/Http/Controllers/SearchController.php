  ...
  */
  public function liveshow(Request $request){
    ...
    foreach ($queries as $query) {
      # code...
      $results[] = [ 'learner_schedule_id' => $query->learner_schedule_id , 'subject_id' => $query->subject_id ,'subject_name' => $query->subject_name , 'level_id' => $query->level_id , 'level_name' => $query->level_name , 'duration_id' => $query->duration_id , 'duration_name' => $query->duration_name , 'day_id' => $query->day_id , 'day_name_full' => $query->day_name_full ] ;
